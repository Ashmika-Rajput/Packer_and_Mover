       ...
       <div className="container-fluid footer text-white mt-5 pt-5 px-0 position-relative overlay-top">
        <div className="row mx-0 pt-5 px-sm-3 px-lg-5 mt-4">
            <div className="col-lg-3 col-md-6 mb-5">
                ...
                <p><i className="fa fa-map-marker-alt mr-2"></i>Courtyard road, Indore, India</p>
                <p><i className="fa fa-phone-alt mr-2"></i>+91 9876543210</p>
                <p className="m-0"><i className="fa fa-envelope mr-2"></i>packers_movers@gmail.com</p>
            </div>
            <div className="col-lg-3 col-md-6 mb-5">
        ...
        <div className="container-fluid text-center text-white border-top mt-4 py-4 px-sm-3 px-md-5" style={{"border-color": "rgba(256, 256, 256, .1) !important"}}>
            <p className="mb-2 text-white">Copyright &copy; <a className="font-weight-bold" href="#">www.packers_movers.com</a>. All Rights Reserved.</p>
            <p className="m-0 text-white">Designed by <a className="font-weight-bold" href="https://htmlcodex.com">---</a></p>
        </div>
    </div>
    </div>
  )
